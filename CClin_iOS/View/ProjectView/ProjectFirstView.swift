    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                List {
                    ForEach(0..<20) { i in
                        projectAlliance(imgaeUrl: "hot_project", category: "#경쟁 #아이디어 공모 #브랜드 홍보 #기획", title: "IoT 서비스의 페르소나 설계 및 기획전 아이디어 공모", companyName: "(주)고퀄")
                            //.padding(.bottom, 10)
                            .cornerRadius(7)
                            .listRowSeparator(.hidden)
                        projectAlliance(imgaeUrl: "hot_project", category: "#인재 채용 #아이디어 공모 #UI/UX", title: "다수의 이동체 관제 모니터링 화면 UI/UX 최적화 방안 공모", companyName: "(주)파블로항공")
                            //.padding(.bottom, 10)
                            .cornerRadius(7)
                            .listRowSeparator(.hidden)
                        projectAlliance(imgaeUrl: "hot_project", category: "#외주 #SW 개발", title: "드론 적재 시스템과 시스템 운영 개념 수립", companyName: "(주)파블로항공")
                            //.padding(.bottom, 10)
                            .cornerRadius(7)
                            .listRowSeparator(.hidden)
                        projectAlliance(imgaeUrl: "hot_project", category: "#인재 채용 #SW 개발", title: "한국어 뉴스 요약 모델을 활용한 개인화 뉴스추천 서비스 개발", companyName: "42MARU")
                            //.padding(.bottom, 10)
                            .cornerRadius(7)
                            .listRowSeparator(.hidden)
                        projectAlliance(imgaeUrl: "hot_project", category: "#경쟁 #인재 채용 #SW 개발", title: "사이드 프로젝트 플랫폼 서비스 기획", companyName: "팀메모리")
                            //.padding(.bottom, 10)
                            .cornerRadius(7)
                            .listRowSeparator(.hidden)
                        projectAlliance(imgaeUrl: "hot_project", category: "#경쟁 #인재 채용 #SW 개발", title: "인공지능 챗봇 솔루션'스윙챗'소셜 마케팅 방안", companyName: "42MARU")
                            //.padding(.bottom, 10)
                            .cornerRadius(7)
                            .listRowSeparator(.hidden)
                        projectAlliance(imgaeUrl: "hot_project", category: "#경쟁 #인재 채용 #SW 개발", title: "사이드 프로젝트 플랫폼 서비스 기획", companyName: "팀메모리")
